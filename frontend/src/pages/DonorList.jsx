...
export default function DonorList() {
  ...
  const hasFilters =
    search || bloodFilter || cityFilter || showCompatible;
  ...
  useEffect(() => {
    const fetchDonors = async () => {
      ...
      try {
        ...
        setError(
          err.response?.data?.message || "Unable to load donors."
        );
      } finally {
        setLoading(false);
      }
    ...
    fetchDonors();
  }, [bloodFilter, cityFilter, search, showCompatible]);
      ...
      <div className="dl-page">
        ...
        <header className="dl-header">
          ...
          <div className="dl-controls">
            ...
            {/* Compatible checkbox */}
            <label className="dl-compatible">
              <input
                type="checkbox"
                checked={showCompatible}
                onChange={(e) =>
                  setShowCompatible(e.target.checked)
                }
              />
        ...
        <main className="dl-grid">
          ...
          {loading ? (
            <div className="dl-empty">
              ...
              <p>
                Please wait while we fetch the latest donor
                availability.
              </p>
            </div>
