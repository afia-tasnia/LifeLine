...
const EMERGENCY_REQUESTS = [
  {
    ...
    urgent: true,
    description:
      "Patient requiring immediate surgery after road accident. Need 2 bags of O+ blood by 4:00 PM today.",
  },
  {
    id: "REQ-2026-03",
    bloodGroup: "A-",
    ...
    urgent: false,
    description:
      "Thalassemia patient needs regular transfusion. Requesting a donor who is nearby in Panthapath/Dhanmondi.",
  },
  {
    id: "REQ-2026-02",
    bloodGroup: "B+",
    ...
    urgent: false,
    description:
      "Replacement donor needed for an upcoming surgery scheduled for tomorrow morning. Donor must be healthy.",
  },
];

const TOP_DONORS = [
  { name: "Ariffin Siddique", blood: "AB+", donations: "20+", tier: "Platinum", tierColor: "#E5E4E2", tierText: "#3D2B2B", borderColor: "#E5E4E2" },
  { name: "Nusrat Jahan",     blood: "O-",  donations: "15",  tier: "Gold",     tierColor: "#D4AF37", tierText: "#fff",    borderColor: "#D4AF37" },
  { name: "Zayan Malik",      blood: "B+",  donations: "10",  tier: "Silver",   tierColor: "#C0C0C0", tierText: "#fff",    borderColor: "#C0C0C0" },
  { name: "Sabbir Hossain",   blood: "A+",  donations: "5",   tier: "Bronze",   tierColor: "#CD7F32", tierText: "#fff",    borderColor: "#CD7F32" },
];

const STATS = [
  { target: 2840,  label: "Registered Donors" },
  { target: 142,   label: "Active Requests" },
  { target: 11205, label: "Successful Transfers" },
];
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-btns">
              <Link to="/requests" className="btn-primary">Request Blood</Link>
            ...
            <div className="quick-search">
              ...
              <p className="qs-hint">*Showing 1,248 active donors in Dhaka region</p>
            </div>
          </div>
        </div>
      ...
      <section className="emergency-section">
        <div className="section-inner">
          <div className="section-header">
            ...
            <Link to="/requests" className="section-link" style={{ color: "var(--rose)" }}>
              View All Cases →
            </Link>
          </div>
          ...
          <div className="request-grid">
            {EMERGENCY_REQUESTS.map((req) => (
              <div key={req.id} className={`request-card ${req.urgent ? "urgent-card" : ""}`}>
                {req.urgent && <div className="urgent-badge">Urgent</div>}
                <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.25rem" }}>
                  <div className="blood-circle">{req.bloodGroup}</div>
                  <div>
                    <div className="card-hospital">{req.hospital}</div>
                    <div className="card-time">Posted {req.postedAgo}</div>
                  </div>
                </div>
                <p className="card-desc">{req.description}</p>
                <div className="card-footer">
                  <span className="card-id">#{req.id}</span>
                  <button className="card-contact">Contact Info</button>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="section-inner">
          ...
          <div className="donors-grid">
            {TOP_DONORS.map((donor) => (
              <div key={donor.name} className="donor-card">
                <div className="donor-blood-badge">{donor.blood}</div>

                <div className="donor-avatar-wrap">
                  <div
                    className="donor-avatar"
                    style={{ background: avatarColor(donor.name) }}
                  >
                    {initials(donor.name)}
                  </div>
                  <div
                    className="donor-tier-badge"
                    style={{ background: donor.tierColor, color: donor.tierText }}
                  >
                    {donor.tier}
                  </div>
                </div>
                ...
                <div className="donor-count">{donor.donations} Donations</div>
                <button className="donor-btn">View Profile</button>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="hiw-section">
        <div className="section-inner">
          ...
          <div className="hiw-cta">
            <Link to="/how-it-works" className="btn-green">Learn More</Link>
          </div>
        </div>
      </section>
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              <ul className="footer-links">
                ...
                <li><Link to="/requests">Emergency Requests</Link></li>
